...
def _(client, model):
    ...
    return add_assistant_message, add_user_message, chat_stream
...
def _():
    ...
    return save_article, save_article_schema
...
@app.cell
def _(add_user_message, run_conversation, save_article_schema):
    messages = []
