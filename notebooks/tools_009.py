...
def _(client, model):
    ...
    return add_assistant_message, add_user_message, chat, text_from_message
...
def _(datetime):
    ...
    return get_current_datetime, get_current_datetime_schema


@app.cell
def _(add_duration_to_datetime, get_current_datetime, set_reminder):
    import json
...
@app.cell
def _(add_user_message, run_conversation):
    messages = []
    add_user_message(
        messages,
